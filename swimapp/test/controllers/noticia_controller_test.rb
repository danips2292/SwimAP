...
class NoticiaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create noticium" do
    assert_difference('Noticium.count') do
      post noticia_url, params: { noticium: { body: @noticium.body, title: @noticium.title } }
    end
  ...
  test "should update noticium" do
    patch noticium_url(@noticium), params: { noticium: { body: @noticium.body, title: @noticium.title } }
